...
const StartScreen: React.FC<StartScreenProps> = ({ onModelFinalized, onCreditsUpdate }) => {
  ...
  const handleFileSelect = useCallback(async (file: File) => {
    ...
    if (credits.balance < cost) {
        setError(`Không đủ credit! Bạn cần ${cost} credit để tạo người mẫu. Hãy mua thêm credit.`);
        return;
    }
          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              <h1 className="text-5xl md:text-6xl font-serif font-bold text-gray-900 leading-tight">
                Tạo người mẫu riêng cho mọi phong cách.
              </h1>
              <p className="mt-4 text-lg text-gray-600">
                Từng thắc mắc bộ đồ này mặc lên sẽ trông thế nào? Đừng đoán nữa. Chỉ cần tải ảnh của bạn lên, AI sẽ tạo người mẫu cá nhân để thử mọi trang phục.
              </p>
              ...
              <div className="flex flex-col items-center lg:items-start w-full gap-3">
                ...
                <p className="text-gray-500 text-sm">Chọn ảnh rõ nét, càng toàn thân càng tốt. Ảnh chân dung vẫn dùng được nhưng toàn thân sẽ cho kết quả đẹp hơn.</p>
                <p className="text-gray-500 text-xs mt-1">Khi tải ảnh, bạn cam kết không tạo nội dung độc hại, phản cảm hoặc vi phạm pháp luật. Hãy sử dụng có trách nhiệm.</p>
