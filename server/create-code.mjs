/**
 * Script đơn giản để tạo credit codes (ESM version)
 * 
 * Cách sử dụng:
 * node create-code.mjs <số_credits> [code_tùy_chỉnh]
 * 
 * Ví dụ:
...
if (!credits) {
  ...
  console.log('\nCách sử dụng:');
  console.log('  node create-code.mjs <số_credits> [code_tùy_chỉnh]');
  console.log('\nVí dụ:');
  console.log('  node create-code.mjs 25');
  console.log('  node create-code.mjs 50 WELCOME50');
  process.exit(1);
}
